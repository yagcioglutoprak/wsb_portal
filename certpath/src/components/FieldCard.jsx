...
export default function FieldCard({ field, index }) {
  ...
  return (
    <Link
      ...
      className="group relative block rounded-xl border-[1.5px] border-ink/12 bg-card shadow-[0_2px_0_0_rgba(0,0,0,0.06)] p-5 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_4px_0_0_rgba(0,0,0,0.06)] hover:border-ink/20"
    ...
    >
      ...
      {/* Figure number */}
      <span className="font-sans text-xs font-normal tracking-wide text-pencil">
        {num}
      </span>

      {/* Field name */}
      <h3 className="mt-3 font-sans text-xl font-semibold text-ink transition-colors duration-200 group-hover:text-rust">
        {field.name}
      </h3>
      ...
      {/* View roadmap link */}
      <p className="mt-3 font-sans text-sm font-semibold uppercase tracking-wide text-rust transition-colors duration-200 group-hover:underline">
        View roadmap &rarr;
      </p>
    </Link>
  );
